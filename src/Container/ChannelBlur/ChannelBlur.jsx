        ...
        return (
            <div onMouseMove={this.handleMouseMove} className="o-channelBlur">
                <div className="o-channelBlur__container">
                    <div style={{left: yXloc, top: yYloc, filter : `blur(${blur})`, textShadow: `0 0 ${blur} rgba(255,255,0,1)` }} className="o-channelBlur__y o-channelBlur__content">{this.props.text}</div>
                    <div style={{left: compX, top: compY, filter : `blur(${blur})`, textShadow: `0 0 ${blur} rgba(255,0,255,1)` }} className="o-channelBlur__m o-channelBlur__content">{this.props.text}</div>
                    <div style={{left: cXloc, top: cYloc, filter : `blur(${blur})`, textShadow: `0 0 ${blur} rgba(0,255,255,1)`}} className="o-channelBlur__c o-channelBlur__content">{this.props.text}</div>
                </div>
            </div>
        )
    }
